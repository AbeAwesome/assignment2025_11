...
class DivideAndConquerTest {
	...
	void testCountSorted10() {		
		...
		for(int i = 0; i < a.length; ) {
			...
			assertEquals(currCount, CountInSorted.countSorted(a, curr));
		}		
	}
	...
	void testCountSorted1024() {		
		...
		assertEquals(12, CountInSorted.countSorted(a, element));
		
		// now see if the complexity is log n
		System.out.println("1024 sort comparisons: " + CountInSorted.comparisons + " expected count is 21");
	...
	void testCountSorted512Repeats() {		
		...
		// assert that the iterative calculated count is equal to that of the recursive
		assertEquals(512, CountInSorted.countSorted(a, element));
	...
	void testCountSorted1024Repeats() {		
		...
		// assert that the iterative calculated count is equal to that of the recursive
		assertEquals(1024, CountInSorted.countSorted(a, element));
