...
public class RecursionChallenge {
	...
	// exercise 3: checks if all the elements of the list (defined by head node) are
	// sorted
	...
	// exercise 4: returns new string where character '*' is inserted between each
	// character of astring
	...
	public static int mult(int n, int m) {
		...
		// Optional idea I added for runtime in mind, (If Math.abs is allowed)
		// Idea is that you swap n and m if you would me doing more recursive calls
		// otherwise.
		// I originally implemented it without Math.abs, but there's really no clean
		// short way to do it without it.
		// If you remove/comment out the if statement below the code will work perfectly
		// normal, just without the idea of optimization in mind.
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"\nTesting Ex. 4: allStar input string: '" + astring + "' output string: '" + allStar(astring) + "'"); // 'h*e*l*l*o'

		astring = "a";
		System.out.println(
				"Testing Ex. 4: allStar input string: '" + astring + "' output string: '" + allStar(astring) + "'"); // a

		astring = "rex pex fex";
		System.out
				.println("\nTesting Ex. 5: noX input string: '" + astring + "' output string: '" + noX(astring) + "'"); // 're
																														// pe
																														// fe'
		...
		System.out.println("\nTesting Ex. 6: mult: " + x + "*" + y + "=" + mult(x, y));
