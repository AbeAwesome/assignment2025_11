...
public class RecursionChallenge {	
	...
	public static int sumN(int n) {
		//DONE: solve this using recursion
	...
	public static int sumList (Node node) {
		//DONE: solve this using recursive list traversal
		
		if(node == null) {
			return 0; 		//base case; fist node is null
		}
		
		if(node.getNext() == null) {
			return node.getData();		//base case; next node is null
		}
	...
	public static boolean isSorted (Node node) {
		//DONE: solve this using recursive list traversal
		 ...
		 if(node.getNext() == null) {  //base case for one element left
				return true;
		 }
		 
		 
		 if(node.getData() > node.getNext().getData()) {  //base case for elements out of order
				return false;
		 }
...
//		return
	...
	public static String noX(String astring) {
        ...
        if (first == 'x') {                              
            ...
            return first + noX(astring.substring(1));     
        }
	...
	public static int mult (int n, int m) {
        ...
        // handles negative multiplier
        if (m < 0) {                                      
            return -mult(n, -m);                          
        }

        //recursive addition for positive m
        return n + mult(n, m - 1);                  
