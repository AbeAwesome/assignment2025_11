...
public class RecursionChallenge {	
	...
	public static String allStar(String astring) {
		...
		if(astring.length() == 0 || astring.length() == 1)
		{
		 ...
		 String temp = astring.charAt(0) + "*";
		return str + temp + allStar(astring.substring(1));
	}
	...
	public static String noX(String astring) {
		...
		char temp = astring.charAt(0);
		if(temp != 'x')
		{
			keep = astring.substring(0,1);
		}
		return str + keep + noX(astring.substring(1));
	}	
